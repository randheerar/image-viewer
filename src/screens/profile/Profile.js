                        ...
                        <div className="profile-details">
                            ...
                            <div  style={{paddingTop:10}}>
                                ...
                                <Modal
                                    ...
                                    <br/> <br/> <br/>
                                    <Button variant="contained" color="primary" onClick={this.updateUsernameHandler}>UPDATE</Button>
                                </Modal>
                            </div>
                        </div>
                    </div>
                            ...
                            {this.state.postModalIsOpen ? <Modal
                                ...
                                {this.state.username} </span>
                                      ...
                                      <span onClick={() => this.increaseLikesHandler(this.state.post.id,this.state.index)}>
                                          {!this.state.likedByUser[this.state.index] ? <FavoriteBorderIcon /> : <FavoriteIcon className="fav" />}
                                      </span>
